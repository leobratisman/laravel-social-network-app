    ...
    <div class="mb-8 pb-8 border-b border-gray-400">
        ...
        <div class="flex justify-between mt-2 items-center">
            <div class="flex">
                ...
                <div v-if="isPersonal()">
                    <svg @click.prevent="deletePost(post)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                         stroke-width="1.5" stroke="currentColor"
                         :class="['mx-2 stroke-red-500 cursor-pointer hover:fill-red-500 w-6 h-6 fill-white']">
